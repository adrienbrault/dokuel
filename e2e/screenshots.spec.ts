		...
		overlay.innerHTML = `
			...
			<div class="modal-panel gap-5 max-w-sm sm:max-w-md w-full relative">
				<div class="flex flex-col items-center gap-2">
					...
					<span class="text-xs font-bold px-2.5 py-1 rounded-full bg-difficulty-easy-bg text-difficulty-easy-text">Easy</span>
				</div>
				<div class="flex flex-col items-center gap-1.5 w-full rounded-2xl bg-bg-inset py-4">
					<span class="text-4xl font-bold tabular-nums tracking-tight text-text-primary">03:42</span>
					<span class="flex items-center gap-1 text-sm font-bold text-accent"><span>⚡</span> New Personal Best</span>
				</div>
				<div class="grid grid-cols-3 gap-2 w-full">
					<div class="flex flex-col items-center gap-0.5 rounded-xl bg-bg-inset py-2.5">
						<span class="text-lg font-bold tabular-nums text-text-primary">12</span>
						<span class="text-[11px] text-text-muted">Played</span>
					</div>
					<div class="flex flex-col items-center gap-0.5 rounded-xl bg-bg-inset py-2.5">
						<span class="text-lg font-bold tabular-nums text-text-primary">02:45</span>
						<span class="text-[11px] text-text-muted">Best</span>
					</div>
					<div class="flex flex-col items-center gap-0.5 rounded-xl bg-bg-inset py-2.5">
						<span class="text-lg font-bold tabular-nums text-text-primary">03:30</span>
						<span class="text-[11px] text-text-muted">Average</span>
					</div>
				</div>
