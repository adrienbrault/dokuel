	...
	await page.evaluate(() => {
		...
		overlay.innerHTML = `
			...
			<div class="modal-panel gap-5 max-w-sm sm:max-w-md w-full relative">
				...
				<div class="flex flex-col items-center gap-2">
					<span class="text-5xl font-mono font-extrabold tabular-nums text-text-primary leading-none">03:42</span>
					<span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-success/15 text-success text-xs font-bold">New Personal Best!</span>
				</div>
				<div class="grid grid-cols-3 gap-2 w-full">
					<div class="flex flex-col items-center gap-0.5 rounded-xl bg-bg-inset py-3"><span class="text-lg font-bold text-text-primary font-mono tabular-nums">12</span><span class="text-[0.6875rem] font-medium text-text-muted">Played</span></div>
					<div class="flex flex-col items-center gap-0.5 rounded-xl bg-bg-inset py-3"><span class="text-lg font-bold text-text-primary font-mono tabular-nums">02:45</span><span class="text-[0.6875rem] font-medium text-text-muted">Best</span></div>
					<div class="flex flex-col items-center gap-0.5 rounded-xl bg-bg-inset py-3"><span class="text-lg font-bold text-text-primary font-mono tabular-nums">03:10</span><span class="text-[0.6875rem] font-medium text-text-muted">Average</span></div>
				</div>
				<div class="flex flex-col gap-3 w-full">
					<button type="button" class="btn btn-lg btn-primary w-full">Play Again</button>
					<button type="button" class="btn btn-lg btn-secondary w-full">New Game</button>
				</div>
			</div>
		`;
