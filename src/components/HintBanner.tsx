...
export function HintBanner({ hint, onDismiss }: HintBannerProps) {
  ...
  return (
    <div className="w-full max-w-lg rounded-xl bg-amber-50 dark:bg-amber-950/50 border border-amber-200 dark:border-amber-800 px-3.5 py-2.5 shadow-sm animate-modal-content">
