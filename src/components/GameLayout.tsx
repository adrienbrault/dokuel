  ...
  return (
    ...
    >
      ...
      >
        <button
          type="button"
          className="w-10 h-10 flex items-center justify-center rounded-xl text-text-muted hover:bg-bg-raised hover:text-text-primary transition-colors touch-manipulation"
          onClick={onBack}
          aria-label="Back"
        >
