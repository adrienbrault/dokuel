...
it("serves distinct crawler metadata while retaining app HTML and dropping stale entity headers", async () => {
  ...
  const response = await onRequest({
    request: new Request(`https://dokuel.com${path}?ignored=yes`),
    next: async () =>
      new Response(
        '<title>Old</title><meta property="og:title" content="Old" /><meta property="og:url" content="Old" /><div id="root"></div>',
        {
          headers: {
