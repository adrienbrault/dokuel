...
`bun run screenshots` writes 15 combined sheets under `e2e/screenshots/combined/`
...
- `feature--<group>.png` (×7) — related scenes across all 4 devices, devices as rows. Groups: `onboarding`, `landing-demo`, `solo`, `numpad`, `multiplayer`, `dark-mode-a`, `dark-mode-b`. Use when you want to compare a feature across viewports.
